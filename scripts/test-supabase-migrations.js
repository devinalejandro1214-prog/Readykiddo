...
const files = [
  'supabase/migrations/20260714080000_initial_readykiddo_schema.sql',
...
let failures = 0;
const expectedOrder = [
  '20260714080000_initial_readykiddo_schema.sql',
  '20260714090000_add_session_telemetry.sql',
  '20260714100000_expand_child_age_ranges.sql',
  '20260715100000_add_name_spelling_progress.sql'
];
if (files.map(file => file.split('/').pop()).join('|') !== expectedOrder.join('|')) {
  failures += 1;
  console.error('Migration order is not the expected four-step sequence.');
}
...
const schema = sql['supabase/migrations/20260714080000_initial_readykiddo_schema.sql'];
