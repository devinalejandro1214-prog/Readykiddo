...
const ITEM_GENERATORS = {
  ...
  crown: c => `
    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M36 66 q7 8 14 0" fill="url(#crwg${c})" stroke="${DARK[c]}" stroke-width="1.5"/>
      ...
      <circle cx="32" cy="73" r="3.5" fill="${LIGHT[c]}" stroke="${DARK[c]}" stroke-width="1.5"/>
      <circle cx="50" cy="73" r="3.5" fill="${COLOR_HEX[c]}" stroke="${DARK[c]}" stroke-width="1.5"/>
      <circle cx="68" cy="73" r="3.5" fill="${LIGHT[c]}" stroke="${DARK[c]}" stroke-width="1.5"/>
