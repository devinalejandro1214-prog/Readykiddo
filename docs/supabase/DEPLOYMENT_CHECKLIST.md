...
- [ ] Run `supabase/schema.sql` once as the baseline in the empty project.
- [ ] Verify `profiles`, `children`, and `game_sessions` exist with RLS enabled.
- [ ] Verify ownership policies for two test users.
- [ ] Merge `codex/supabase-reconnection` into the production branch only after review.
- [ ] Let Git integration apply migrations in timestamp order: `20260714090000`, `20260714100000`, `20260715100000`.
